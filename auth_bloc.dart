...
import 'package:flash_app/fire_base/fire_base_auth.dart';
...
class Authentication with ChangeNotifier
{
  ...
  {
    const url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAcNWnRxHy-nb6dgGPfQZPfnDq7m8_jtfM';
